...
def create_model_crf(embeddings_matrix, vocab_size = 4517, embedding_dim = 100, max_length = 200):
    ...
    x = TimeDistributed(Dense(units=128, activation='relu', kernel_initializer='he_normal'))(x)
    x = BatchNormalization()(x)
    x = Dropout(rate=0.5)(x)
    x = Dense(21, activation='relu', kernel_initializer='he_normal')(x)
    x = BatchNormalization()(x)
